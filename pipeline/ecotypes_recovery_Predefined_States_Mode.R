...
# key_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_8_Peng_Discovered_States_EcoTyper_PDSM_Run_083022")

key_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", keyDir)

# states_dir = file.path("../EcoTyper", dataset, fractions, "Cell_States", "recovery", test_dataset)

#### NOTE HERE: we use the state assignments from step 1 of bulk recovery based on our prior PDSM discovery run (test 8). We then use the ecotypes discovered using the entire matrix as the ecotype input directory 

states_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_8_Peng_Discovered_States_EcoTyper_PDSM_Run_083022", "TCGA_Recovery_090122")
# states_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", outputDir)

# inpput_dir = file.path("../EcoTyper", dataset, fractions, "Ecotypes", "discovery")
input_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", keyDir, "Ecotypes")

# output_dir = file.path("../EcoTyper", dataset, fractions, "Ecotypes", "recovery", test_dataset)
output_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", outputDir, "Ecotypes") 
...
# tmp = read_clinical_bulk(clinical$ID, dataset_type = "bulk")
