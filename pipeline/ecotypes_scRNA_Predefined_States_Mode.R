...
dataset = "PDAC_scRNA_discovery_010622"
fractions = "Cell_type_specific_genes"

# key_dir = file.path("../EcoTyper", dataset, fractions, "Analysis", "rank_selection")
# key_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_5_Example_scRNA_seq_Data")
key_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", states_output_folder)


# states_dir = file.path("../EcoTyper", dataset, fractions, "Cell_States", "discovery")
# states_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_5_Example_scRNA_seq_Data")
states_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", states_output_folder)

# output_dir = file.path("../EcoTyper", dataset, fractions, "Ecotypes", "discovery")
# output_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_5_Example_scRNA_seq_Data", "EcoTypes")
output_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", states_output_folder, "Ecotypes")
...
{	
    ...
    mapping_path = file.path(states_dir, cell_type, 'mapping_to_initial_states.txt')
    classes_path = file.path(states_dir, cell_type, 'initial_state_assignment.txt')
    classes_filt_path = file.path(states_dir, cell_type, 'state_assignment.txt')
...
#     clinical = read_clinical_manual(classes$ID, dataset = dataset)
...
write.table(all_classes, file.path(output_dir, "all_classes.txt"), sep = "\t", row.names = F)
