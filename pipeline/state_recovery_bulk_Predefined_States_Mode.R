...
# states_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_8_Peng_Discovered_States_EcoTyper_PDSM_Run_083022", cell_type)
states_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", keyDir, cell_type)


# output_dir = file.path("../EcoTyper", dataset, fractions, "Cell_States", "recovery", new_dataset, cell_type, n_states) 
# output_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_8_Peng_Discovered_States_EcoTyper_PDSM_Run_083022", "TCGA_Recovery_090122", cell_type) 
output_dir = file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", outputDir, cell_type) 
...
# data = read.delim(file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", "Test_8_Peng_Discovered_States_EcoTyper_PDSM_Run_083022", "TCGA_Recovery_090122", "Inputs", "data.txt"))
data = read.delim(file.path("../Generate_Cell_State_Abundances_Predefined_States_Test_Outputs", inputDir, "data.txt"))
...
# #### CHANGED FROM GENE INFO TO INITIAL GENE INFO                                                       
# gene_info = read.delim(file.path(states_dir, "gene_info.txt"))
# # gene_info = read.delim(file.path(states_dir, "initial_gene_info.txt"))
